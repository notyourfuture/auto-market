        ...
        <TableBody>
          {cart.autos.map((item) => (
            ...
            >
              ...
              }} type="number" value={item.count} min="1" /> </TableCell>
              <TableCell align="right">{item.subPrice}</TableCell>
              <TableCell align="right"> < img style={{cursor: "pointer"}} width="30" src={DeleteIcon} alt="del-icon" onClick={() => deleteAutoInCart(item.auto.id)} /> </TableCell>
            </TableRow>
          ))}
        </TableBody>
        <TableFooter>
